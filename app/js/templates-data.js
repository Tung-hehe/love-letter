// templates-data.js — danh sách 8 phong cách thư dùng xuyên suốt app.
...
const TEMPLATE_LIST = [
  ...
  { id: 'nong_nan', file: 'template_nong_nan.html', name: 'Nồng nàn', mood: 'say đắm',
    gradient: 'linear-gradient(160deg,#f6e9ec 0%,#ecd8dd 100%)', ink: '#8a4258',
  ...
  { id: 'binh_yen', file: 'template_binh_yen.html', name: 'Bình yên', mood: 'êm đềm',
    gradient: 'linear-gradient(160deg,#f3efe2 0%,#e6ecdc 55%,#dde5d3 100%)', ink: '#414d38',
    iconGradient: 'linear-gradient(135deg,#7c9473,#414d38)',
